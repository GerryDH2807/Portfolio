...
<html>
    ...
    <body>
        <table>
            <tr>
                <td align="left" style="width: 33.33%;"><img src="img/logo-tec.png" style="width: 35%;height: 15%;" id="logo-tec"></td>
        ...
        <table>
            <tr>
                ...
                <td align="center" style="width: 33.33%;" class="logo"><img src="img/logo-expo2.svg" style="width: 100%;height: 100%;" id="logo-tec"></td>
                <td style="width: 33.33%;"></td>
            </tr>
        </table>
