...
<html>
	...
	<body>
        ...
        <div class="scrollogo">
			<table align="center">
				<tr>
					<td align="center" style="width: 33.33%;"><h1 style="font-size: 35px;"><strong>Registrar Profesor</strong></h1></td>
		...
		<form class="form-horizontal" action="create.php" method="post" onsubmit ="return verifyPassword()">
            ...
            <center>
                <div align="center">
                    <input type="text" id="matricula" name="matricula" required maxlength="30" placeholder="  XXXXXXXXX" size="70" class="input" value="<?php echo !empty($matricula)?$matricula:'';?>">
